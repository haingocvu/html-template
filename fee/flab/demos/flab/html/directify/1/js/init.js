...
function directify_fn_single_carousel(){
	...
	jQuery('.directify_fn_all_in_one_single_wrap .single_carousel_wrap .custom_nav > a.prev').on('click', function(){
		carousel.trigger('prev.owl.carousel');
		return false;
	});
	
	jQuery('.directify_fn_all_in_one_single_wrap .single_carousel_wrap .custom_nav > a.next').on('click', function(){
